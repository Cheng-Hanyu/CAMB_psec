...
!chy
    function TAxionEffectiveFluid_w_de(this, grhornomass, grhog, grhoc, grhob, grhonu_mio, grhok, grhocrit, a)
!chy
    class(TAxionEffectiveFluid) :: this
...
!chy
    function TAxionEffectiveFluid_grho_de(this, grhornomass, grhog, grhoc, grhob, grhonu_mio, grhok, grhocrit, a)  !relative density (8 pi G a^4 rho_de /grhov)
