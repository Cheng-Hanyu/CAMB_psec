...
!chy
        ...
        real(dl) :: Omega2_chy = 0._dl  ! Omega2 parameter
!chy
...
!chy
        ...
        numerator = a * (this%Omega1_chy + (1._dl - 0.8_dl*a) * this%Omega2_chy)
        denominator = (1._dl - a) * (this%Omega1_chy + 0.6_dl * (1._dl - 2._dl/3._dl * a) * this%Omega2_chy) - OmegaDE0_chy
        
        ! Check for potential division by zero or other numerical issues
        if (abs(denominator) < 1.e-10_dl) then
            TDarkEnergyEqnOfState_w_de = -1._dl  ! Avoid division by zero
        else
            TDarkEnergyEqnOfState_w_de = -1._dl + (1._dl/3._dl) * numerator / denominator
        endif
!chy
    else
        al=dlog(a)
...
!chy
        ...
        grho_de = a**4._dl * (1._dl + (a-1._dl) * (this%Omega1_chy + this%Omega2_chy) / OmegaDE0_chy + (0.4_dl) * (1._dl - a**2._dl) * this%Omega2_chy / OmegaDE0_chy)
!chy
    else
        if(a == 0.d0)then
...
!chy
        ...
        write(*,'("Omega2 = ", f8.5)') this%Omega2_chy
!chy
    endif
...
!chy
        ...
        this%Omega2_chy = Ini%Read_Double('Omega2_chy', 0._dl)
!chy
...
!chy
    this%is_cosmological_constant = .not. this%use_tabulated_w .and. &
        & this%Omega1_chy == 0._dl .and. this%Omega2_chy == 0._dl
!chy
