    ...
    real(dl), intent(in) :: a
!edv
    real(dl) :: dtauda, rhonu, grhoa2, a2, grhov_t, w
...
!edv
    ...
    a2 = a ** 2
!edv
    call this%CP%DarkEnergy%BackgroundDensityAndPressure(this%grhov, a, grhov_t, w, &
                        & this%grhornomass, this%grhog, this%grhoc, this%grhob, this%grhonu_mio, this%grhok, this%grhocrit)
...
!edv
    call State%CP%DarkEnergy%BackgroundDensityAndPressure(State%grhov, a, grhov_t, w_dark_energy_t, State%grhornomass, State%grhog,&
        & State%grhoc, State%grhob, State%grhonu_mio, State%grhok, State%grhocrit)
...
!edv
    ...
    grhog_t=State%grhog/a2
!edv
    call CP%DarkEnergy%BackgroundDensityAndPressure(State%grhov, a, grhov_t, w_dark_energy_t, State%grhornomass, State%grhog,&
                       & State%grhoc, State%grhob, State%grhonu_mio, State%grhok, State%grhocrit)
